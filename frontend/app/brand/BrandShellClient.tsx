...
const navItems: NavItem[] = [
  { href: "/brand", label: "Dashboard", icon: BarChart3 },
  { href: "/brand/matches", label: "Browse Matches", icon: Target },
  { href: "/brand/bids", label: "My Bids", icon: Radio },
  { href: "/brand/creatives", label: "Promotional Material", icon: Component },
  { href: "/brand/balance", label: "Deposit Funds", icon: CircleDollarSign },
  { href: "/brand/history", label: "History & Refunds", icon: Clock3 },
];
