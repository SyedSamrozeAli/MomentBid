...
urlpatterns = [
    ...
    path("creatives/<int:creative_id>/", CreativeDetailView.as_view(), name="creative-detail"),
    ...
    path("matches/<int:match_id>/bids/all/", MatchBidListView.as_view(), name="match-bids-list"),
    path("matches/<int:match_id>/bids/leaderboard/", MatchBidLeaderboardView.as_view(), name="match-bids-leaderboard"),
